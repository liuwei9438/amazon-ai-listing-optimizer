...
VERSION = "V2.0-core-P1.4-checkpoint-cache-test"
MAX_TITLE_LEN = 75
...
TEXT_DISK_CACHE = JsonResultCache("listing_results_p14")
ANALYSIS_DISK_CACHE = JsonResultCache("product_analysis_p14")
TASK_MANAGER = TaskManager("p14")
...
def stable_cache_key(source: dict[str,Any], language: str) -> str:
    return result_fingerprint(source, language, schema="v2.0-core-p1.4")
