...
TEXT_DISK_CACHE = JsonResultCache("listing_results_v21_hybrid")
ANALYSIS_DISK_CACHE = JsonResultCache("product_analysis_v21_hybrid")
TASK_MANAGER = TaskManager("v21_hybrid")
